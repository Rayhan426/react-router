...
const Author = () => {
    ...
    const { name,  profile_image, username, github_username, website_url} = blog.user;
    console.log(blog);
    return (
        ...
        <div className="space-y-4 text-center divide-y dark:divide-gray-300">
            ...
            <div className="flex justify-center pt-2 space-x-4 align-center">
                ...
                <a  href={`https://github.com/${website_url}`} aria-label="Dribble" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
